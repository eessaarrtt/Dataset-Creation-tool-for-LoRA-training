...
TRANSLATIONS = {
    'ru': {
        ...
        'seedream_v45_6': 'Цена: $0.04 за изображение',
        ...
        'seedream_v4_6': 'Идеально для: иллюстраций и разнообразных стилей',
    ...
    'en': {
        ...
        'seedream_v45_6': 'Price: $0.04 per image',
        ...
        'seedream_v4_6': 'Ideal for: illustrations and various styles',
