...
TRANSLATIONS = {
    'ru': {
        ...
        'skipping_image_after_errors': 'Пропускаем изображение "{name}" после 3 неудачных попыток: {error}',
        
        # Обновления
        'not_git_repo': 'Это не git репозиторий. Обновления через git недоступны.',
        'fetch_failed': 'Не удалось получить информацию об обновлениях: {error}',
        'cannot_determine_branch': 'Не удалось определить текущую ветку',
        'updates_available': 'Доступно обновлений: {count}\nПоследние изменения:\n{commits}',
        'no_updates_available': 'У вас установлена последняя версия',
        'update_check_timeout': 'Таймаут при проверке обновлений',
        'update_check_failed': 'Ошибка при проверке обновлений: {error}',
        'git_not_installed': 'Git не установлен. Установите git для использования обновлений.',
        'update_check_error': 'Ошибка при проверке обновлений: {error}',
        'updating_repository': 'Обновление репозитория',
        'current_version': 'Текущая версия: {commit} (ветка: {branch})',
        'uncommitted_changes_warning': 'Обнаружены незакоммиченные изменения',
        'stash_changes_prompt': 'Сохранить изменения во временное хранилище (stash)?',
        'changes_stashed': 'Изменения сохранены',
        'update_success': 'Обновление успешно! {old_commit} → {new_commit}',
        'already_up_to_date': 'Уже установлена последняя версия',
        'update_failed': 'Ошибка при обновлении: {error}',
        'update_error': 'Ошибка при обновлении: {error}',
        'cannot_get_version': 'Не удалось получить информацию о версии',
        'checking_updates': 'Проверка обновлений...',
        'update_available_prompt': 'Доступно обновление! Обновить сейчас? (y/n): ',
        'update_command_help': 'Обновить скрипт из GitHub репозитория',
        'check_updates_command_help': 'Проверить наличие обновлений',
        'force_update_command_help': 'Принудительное обновление (сброс локальных изменений)',
        'restart_required': 'Перезапустите скрипт для применения обновлений',
        ...
        'seedream_v4_5': 'Хорошее качество генерации',
    ...
    'en': {
        ...
        'skipping_image_after_errors': 'Skipping image "{name}" after 3 failed attempts: {error}',
        
        # Updates
        'not_git_repo': 'This is not a git repository. Git updates are not available.',
        'fetch_failed': 'Failed to fetch update information: {error}',
        'cannot_determine_branch': 'Cannot determine current branch',
        'updates_available': 'Updates available: {count}\nRecent changes:\n{commits}',
        'no_updates_available': 'You have the latest version',
        'update_check_timeout': 'Timeout while checking for updates',
        'update_check_failed': 'Error checking for updates: {error}',
        'git_not_installed': 'Git is not installed. Install git to use updates.',
        'update_check_error': 'Error checking for updates: {error}',
        'updating_repository': 'Updating repository',
        'current_version': 'Current version: {commit} (branch: {branch})',
        'uncommitted_changes_warning': 'Uncommitted changes detected',
        'stash_changes_prompt': 'Save changes to temporary storage (stash)?',
        'changes_stashed': 'Changes saved',
        'update_success': 'Update successful! {old_commit} → {new_commit}',
        'already_up_to_date': 'Already up to date',
        'update_failed': 'Error updating: {error}',
        'update_error': 'Error updating: {error}',
        'cannot_get_version': 'Cannot get version information',
        'checking_updates': 'Checking for updates...',
        'update_available_prompt': 'Update available! Update now? (y/n): ',
        'update_command_help': 'Update script from GitHub repository',
        'check_updates_command_help': 'Check for available updates',
        'force_update_command_help': 'Force update (reset local changes)',
        'restart_required': 'Restart the script to apply updates',
        ...
        'seedream_v4_5': 'Good generation quality',
